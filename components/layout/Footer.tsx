    ...
    <footer className="bg-muted/50 safari-texture border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Discover Africa's greatest adventures with our AI-powered safari marketplace. Connecting you to
              unforgettable experiences across the continent.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Link href="/tours" className="block text-muted-foreground hover:text-orange-500 transition-colors">
                Browse Tours
              </Link>
              <Link
                href="/destinations"
              ...
              <Link href="/about" className="block text-muted-foreground hover:text-orange-500 transition-colors">
                About Us
              </Link>
        ...
        <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">© {new Date().getFullYear()} Tripesa. All rights reserved.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link href="/privacy" className="text-muted-foreground hover:text-orange-500 text-sm transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-muted-foreground hover:text-orange-500 text-sm transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
